    ...
    if(email && password) {
      ...
      signInWithEmailAndPassword( auth, email, password )
        .then((userCredential) => {
          ...
          //...
          setLoading(false);
          setSuccessMsg("Login Successful! Welcome you back!!!");
          setTimeout(() => {
            navigate("/")
          }, 2000)
        })
        .catch((error) => {
          ...
          console.log("Something is up, Try with correct user Credentials!");
        });
      setEmail("");
      setPassword("");
    }
      ...
      <div className='w-full bg-gray-100 pb-10'>
        {
          ...
          <form className='w-[300px] mx-auto flex flex-col items-center'>
          <img className='w-32' src={darklogo} alt='darkLogoImg' />
            ...
            <div className='flex flex-col gap-3'>
              <div className='flex flex-col gap-2'>
                ...
                <input 
                  ...
                  value={email}
                  className='w-full lowercase py-1 border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100' type='email' 
                />
                {
                  errEmail && (
              ...
              <div className='flex flex-col gap-2'>
                ...
                <input 
                  ...
                  value={password}
                  className='w-full lowercase py-1 border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100' type='password' 
                />
                {
                  errPassword && (
                    <p className='text-red-600 text-xs font-semibold tracking-wide flex items-center gap-2 -mt-1.5'>
